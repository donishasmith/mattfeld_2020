...
psb6351_wf.connect(tshifter, 'out_file', spatial_blur, 'in_files')
...
psb6351_wf.connect(spatial_blur, 'out_file', datasink, 'spatial.blur') #All files saved in datasink
#Noted that the all blurred filed have naming scheme '_bold_volreg_tshift_merge.nii.gz' 
#Data is now motion corrected, slice timing corrected, and spatially blurred.
